    ...
    const courses = [
        {
            ...
            description: 'Học viên được trang bị kiến thức toàn diện từ HTML5, CSS3, JavaScript ES6+, React.js, Tailwind CSS đến xây dựng RESTful API chuẩn mực với Node.js, Express, PostgreSQL. Kết thúc khóa làm đồ án tốt nghiệp thực chiến.',
            totalHours: 90,
        ...
        },
        {
            ...
            description: 'Làm quen cú pháp Python, xử lý dữ liệu với Pandas, NumPy, trực quan hóa biểu đồ với Matplotlib/Seaborn và tự động hóa công việc văn phòng.',
            totalHours: 60,
        ...
        },
        {
            ...
            description: 'Đào tạo kiến trúc Microservices, Spring Boot, Spring Security, Hibernate ORM và triển khai Docker container trong môi trường production.',
            totalHours: 85,
        ...
        },
        {
            ...
            description: 'Phương pháp rèn luyện 4 kỹ năng Nghe - Nói - Đọc - Viết với giảng viên bản ngữ và giảng viên đạt IELTS 8.0+. Chấm chữa bài chi tiết hàng tuần.',
            totalHours: 72,
        ...
        },
        {
            ...
            description: 'Khóa học thực hành chuyên sâu theo đề thi chứng chỉ Microsoft Office Specialist. Nắm vững kỹ năng bảng tính, biểu đồ, macro nâng cao.',
            totalHours: 45,
