  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <section className="relative min-h-[252px] overflow-hidden bg-gradient-to-b from-blue-900 via-blue-800 to-indigo-950 px-4 pt-12 pb-20 text-white sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 mx-auto flex min-h-full max-w-7xl flex-col justify-center gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-blue-100/80 max-w-xl">
              Theo dõi trạng thái xét duyệt đơn tuyển sinh, hạn đóng học phí và
              thông tin lớp học.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/my-learning" className="shrink-0">
              <Button
                variant="outline"
                size="sm"
      ...
      <main className="relative z-20 mx-auto -mt-10 max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {isLoading ? (
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-slate-200 py-16 text-center px-8">
                ...
                <p className="text-xs text-slate-500 mt-1.5 max-w-sm mx-auto leading-relaxed">
                  Bạn chưa đăng ký khóa học nào. Hãy khám phá danh mục các khóa
                  đào tạo ngắn hạn để chọn lớp học phù hợp.
                </p>
                <a
                  href="/courses"
              ...
              <div className="space-y-4">
                {registrations.map((r) => {
                  const stCls =
                    STATUS_STYLE[r.status as RegistrationStatus] ||
                    STATUS_STYLE.CANCELLED;
                  const stLabel =
                    STATUS_LABEL[r.status as RegistrationStatus] || r.status;
                    ...
                    >
                      ...
                      <div className="p-5">
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <span
                            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold border shrink-0 ${stCls}`}
                          >
                            {stIcon}
                            {stLabel}
                          </span>
                        ...
                        <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 gap-3">
                          <div className="flex items-center gap-1.5 text-xs text-slate-600">
                            ...
                            <span>
                              Đăng ký:{" "}
                              <strong>{formatDate(r.registrationDate)}</strong>
                            </span>
                          </div>
                          ...
                          {r.period?.expectedStartDate && (
                            <div className="flex items-center gap-1.5 text-xs text-slate-600">
                              ...
                              <span>
                                Khai giảng:{" "}
                                <strong>
                                  {formatDate(r.period.expectedStartDate)}
                                </strong>
                              </span>
                            </div>
                          )}
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              {r.invoice.paymentStatus === "PAID" ? (
                                ...
                                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-blue-100 text-blue-700 border border-blue-200">
                                  <CreditCard className="h-3 w-3" /> Đóng một
                                  phần
                                </span>
                              ) : (
                            ...
                            <div className="grid grid-cols-3 gap-2 text-center">
                              <div className="bg-white rounded-lg p-2 border border-amber-100">
                                ...
                                <p className="text-xs font-bold font-mono text-slate-800 mt-0.5">
                                  {formatVND(r.invoice.totalAmount)}
                                </p>
                              </div>
                              <div className="bg-white rounded-lg p-2 border border-amber-100">
                                <p className="text-[9px] text-slate-400 uppercase font-semibold">
                                ...
                                <p className="text-xs font-bold font-mono text-emerald-700 mt-0.5">
                                  {formatVND(r.invoice.paidAmount)}
                                </p>
                              </div>
                              <div className="bg-white rounded-lg p-2 border border-amber-100">
                                <p className="text-[9px] text-slate-400 uppercase font-semibold">
          ...
          <aside className="lg:col-span-4 space-y-4">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="space-y-3 text-xs text-slate-600">
                <div className="flex items-start gap-2.5">
                  <span className="h-5 w-5 rounded-full bg-blue-100 text-blue-700 font-bold text-[10px] flex items-center justify-center shrink-0 mt-0.5">
                    1
                  </span>
                  <div>
                    ...
                    Giáo vụ kiểm tra thông tin và đối chiếu số lượng chỉ tiêu
                    của đợt.
                  </div>
                </div>
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    Đơn được duyệt sẽ tự động kích hoạt hóa đơn học phí kèm mã
                    QR.
                  </div>
                </div>
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    Học viên theo dõi lịch học tại Cổng học tập cá nhân.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-blue-100 bg-blue-50/60 p-5 text-xs text-blue-900">
              ...
              <p className="text-blue-800/80 leading-relaxed">
                Nếu bạn cần điều chỉnh đợt học hoặc hủy đơn gấp, vui lòng liên
                hệ hotline <strong>(0263) 3822 246</strong> hoặc qua trang{" "}
                <a href="/admissions" className="underline font-semibold">
                  Hỗ trợ tuyển sinh
                </a>
                .
              </p>
