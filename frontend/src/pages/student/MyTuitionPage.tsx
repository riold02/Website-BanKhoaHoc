  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      <section className="relative min-h-[252px] overflow-hidden bg-gradient-to-b from-blue-900 via-blue-800 to-indigo-950 px-4 pt-12 pb-20 text-white sm:px-6 lg:px-8">
        <div className="mx-auto flex min-h-full max-w-7xl flex-col justify-center gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm text-blue-100">
              Theo dõi tổng số tiền phải đóng, số tiền đã nộp và hướng dẫn
              chuyển khoản thanh toán theo hóa đơn.
            </p>
          </div>

          <Link to="/my-learning" className="shrink-0 self-start md:self-auto">
            <Button
              variant="outline"
              size="sm"
      ...
      <main className="relative z-20 mx-auto -mt-10 max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        {invoices.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-slate-300 bg-white p-10 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Khi đơn đăng ký được duyệt, hệ thống sẽ tự tạo hóa đơn cho bạn để
              thanh toán.
            </p>
          </div>
        ) : (
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col gap-4 border-b border-slate-200 pb-4 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <span
                        className={`inline-flex items-center rounded-full border px-2.5 py-1 text-[11px] font-semibold ${STATUS_STYLE[invoice.paymentStatus] || "bg-slate-100 text-slate-700 border-slate-200"}`}
                      >
                    ...
                    <div className="mt-4 grid gap-4 md:grid-cols-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xl font-black text-emerald-600">
                          {formatVND(Number(invoice.paidAmount || 0))}
                        </p>
                      </div>
                    ...
                    <div className="mt-4 grid gap-2 text-sm text-slate-600 sm:grid-cols-2">
                      <div className="rounded-xl bg-slate-50 p-3">
                        ...
                        <p className="mt-1 font-semibold text-slate-800">
                          {invoice.registration?.period?.course?.title || "--"}
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl bg-slate-50 p-3">
                        ...
                        <p className="mt-1 font-semibold text-slate-800">
                          {formatDate(invoice.dueDate || undefined)}
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="mt-4 rounded-2xl border border-blue-100 bg-blue-50/60 p-4">
                        ...
                        <div className="mt-3 grid gap-3 text-sm text-slate-700 sm:grid-cols-2">
                          <div>
                            ...
                            <p className="mt-1 font-semibold text-slate-800">
                              {transferInfo.bankName || "Vietcombank"}
                            </p>
                          </div>
            ...
            <aside className="space-y-5">
              <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-4 flex justify-center rounded-2xl bg-slate-100 p-3">
                  <QRCodeDemo
                    value={`HP ${invoices[0]?.invoiceCode || "INV-XXXX"}`}
                  />
                </div>

                <p className="mt-3 text-xs text-slate-500">
                  Quét mã QR để chuyển khoản nhanh. Vui lòng ghi đúng nội dung
                  chuyển khoản để hệ thống đối chiếu hóa đơn.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <ol className="mt-4 space-y-3 text-sm text-slate-600">
                  <li className="flex gap-3">
                    <span className="mt-0.5 flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-xs font-bold text-blue-700">
                      1
                    </span>
                    <span>
                      Chuyển khoản theo thông tin ngân hàng hiển thị trên hóa
                      đơn.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <span>
                      Ghi đúng nội dung:{" "}
                      <strong>
                        HP {invoices[0]?.invoiceCode || "INV-XXXX"}
                      </strong>
                      .
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <span>
                      Gửi xác nhận hoặc lưu mã giao dịch để giáo vụ đối soát
                      nhanh hơn.
                    </span>
                  </li>
                </ol>
