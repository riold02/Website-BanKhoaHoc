    ...
    switch (location.pathname) {
      case "/admin":
        return {
          ...
          subtitle:
            "Tổng quan chỉ số đào tạo, khóa học và hoạt động tuyển sinh",
      ...
      case "/admin/courses":
        return {
          ...
          subtitle:
            "Thiết lập danh mục, đề cương, thời lượng và học phí định mức",
      ...
      case "/admin/classes":
        return {
          ...
          subtitle: "Theo dõi lớp học, lịch buổi học và danh sách học viên",
          breadcrumbs: ["Quản Trị", "Lớp Học"],
        };
      default:
        return {
